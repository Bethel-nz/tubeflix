const CardSkeleton = () => {
  return (
    <div className='rounded-md w-full sm:w-48 md:w-56 lg:w-64 h-72 sm:h-80 md:h-88 lg:h-96 relative group overflow-hidden shadow-lg animate-pulse'>
      ...
      <div className='bg-slate-900/30 border-2 border-gray-400/40 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md rounded-r-md absolute -bottom-10 p-4 h-1/3 w-full group-hover:bottom-0 opacity-0 group-hover:opacity-100 transition-all ease-bezier duration-500 delay-300'>
